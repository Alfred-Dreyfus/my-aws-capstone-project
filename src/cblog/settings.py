...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cu1cwjsq10by.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'dreyfus-blog' # please enter your s3 bucket name
